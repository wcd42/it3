...
class MySQLCourseDAO(CourseDAO):
    ...
    @classmethod
    def insert_employee(cls, course: Course):
    ...
    @classmethod
    def update_employee(cls, course: Course):
        courseid = course.get_course_id()
        faculty = course.get_faculty()
        coursename = course.get_course_name()
    ...
    def find_employee_by_property(self, search_type: CourseSearchType, value: object) -> List[Course]:
        pass
